    ...
    <div className="min-h-screen pt-16">
      <div className="relative h-[40vh] bg-black">
        ...
        <div className="relative h-full flex items-center justify-center text-white">
          <h1 className="text-5xl font-bold">À propos de Bohoh car </h1>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Depuis notre création, Bohoh car  s'est engagé à redéfinir l'expérience
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                content: 'Bohoh car  est mon partenaire de confiance pour tous mes déplacements professionnels. Qualité et fiabilité garanties.'
              },
              {
                name: 'Julie M.',
                role: 'Touriste',
                content: 'Une expérience parfaite du début à la fin. Je recommande vivement Bohoh car  pour découvrir le Maroc.'
              }
