              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="tel:+212666836259" className="hover:text-yellow-500">
                      +212 666-836259
                    </a>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@bohohcar.ma" className="hover:text-yellow-500">
                      contact@bohohcar.ma
                    </a>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p>7389+M3F, Beni Ensar I Aït Nsar</p>
                  </div>
                </div>
              </div>
