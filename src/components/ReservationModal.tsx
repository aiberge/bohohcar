...
export default function ReservationModal({ car, onClose }: ReservationModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = encodeURIComponent(`Bonjour, je souhaite louer une voiture via votre site Bohohcar.
...
Merci de me confirmer la disponibilité !`);
    ...
    window.open(`https://wa.me/212666836259?text=${message}`, '_blank');
    onClose();
  };
